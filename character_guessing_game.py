...
client = openai.OpenAI(api_key=user_api_key)
prompt = """Act as an Akinator. You will receive a clue from the player, and your job is to guess the character or person that the player is thinking of.
You will first ask the player "Is your character a real person?", then you will start to guess the character based on the player's answer.
"""
...
if st.session_state.get("asked_real_person", False) is False:
